...
class ASIN:
    ...
    def fetch_asin(self):
        for x in range(1, self.max_pages + 1):
            url = f"https://www.amazon.com/s?i=computers-intl-ship&bbn=16225007011&rh=n%3A13896617011%2Cp_123%3A42439&dc&qid=1751736516&rnid=85457740011&xpid=hBeZvBFpEv035&ref=sr_pg_{x}"
    ...
    def fetch_product_data(self, asin):
        """Fetch product data for an individual ASIN."""
        try:
            ...
            print(f"✅ Extracting Data from {asin}")
